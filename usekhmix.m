...
mxp.Pc = [45.99 48.72 42.48]*1e5; mxp.Tc = [190.6 305.3 369.8];
mxp.w = [0.012 0.1 0.152]; mxp.k = zeros(3,3);
mxp.Afi = [8.245223 0.3806333e-2 0.8864745e-5 -0.7461153e-8 0.182296e-11;
